...
use frontend\models\search\ReporteOrganizacionSearch;
use Yii;
use frontend\models\Reporte;
use frontend\models\search\ReporteSearch;
use frontend\models\search\ReporteHorasSearch;
use frontend\models\search\ReporteProyectoSearch;
...
class ReporteController extends Controller
{
    ...
    public function actionReporteHoras()
    {
        $searchModel = new ReporteHorasSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
        return $this->render('reporte-horas',[
            'searchModel' => $searchModel,
            'dataProvider' => $dataProvider,
        ]);
    }
    public function actionReporteProyectos()
    {
        $searchModel = new ReporteProyectoSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
        return $this->render('reporte-por-proyecto',[
            'searchModel' => $searchModel,
            'dataProvider' => $dataProvider,
        ]);
    }
    public function actionReporteOrganizaciones()
    {
        $searchModel = new ReporteOrganizacionSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
        return $this->render('reporte-por-organizacion',[
            'searchModel' => $searchModel,
            'dataProvider' => $dataProvider,
        ]);
    }
