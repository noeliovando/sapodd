...
$this->title = 'Reporte de Actividades';
...
<div class="reporte-index">
    ...
    for($i=0;$i<12;$i++)
    {
        $plan[$i]=$searchModel->getNumeroPlan($i+1)+0;
        $real[$i]=$searchModel->getNumeroReal($i+1)+0;
    }
    '<div class="col-lg-3">';
    ...
    echo Highcharts::widget([
        'options' => [
            ...
            'title' => ['text' => 'Servicios atendidos en '.date('Y')],
            ...
            'series' => [
                ['name' => 'Plan', 'data' => $plan,'type'=> 'column',],
                ['name' => 'Real', 'data' => $real,'type'=> 'column',],
    ...
    echo '<div><h3>Servicios atendidos por Actividad (Cantidad)</h3></div>';
    echo GridView::widget([
            ...
            'columns' => [
                ...
                [
                    ...
                    'value' => function($data){
                        return $data::getNumeroActividades($data->id_detallada,"01");
                    }
                ],
                [
                    'label' => 'Febrero', 'format' => 'html',
                    'value' => function($data){
                        return $data::getNumeroActividades($data->id_detallada,"02");
                    }
                ],
                [
                    'label' => 'Marzo', 'format' => 'html',
                    'value' => function($data){
                        return $data::getNumeroActividades($data->id_detallada,"03");
                    }
                ],
                [
                    'label' => 'Abril', 'format' => 'html',
                    'value' => function($data){
                        return $data::getNumeroActividades($data->id_detallada,"04");
                    }
                ],
                [
                    'label' => 'Mayo', 'format' => 'html',
                    'value' => function($data){
                        return $data::getNumeroActividades($data->id_detallada,"05");
                    }
                ],
                [
                    'label' => 'Junio', 'format' => 'html',
                    'value' => function($data){
                        return $data::getNumeroActividades($data->id_detallada,"06");
                    }
                ],
                [
                    'label' => 'Julio', 'format' => 'html',
                    'value' => function($data){
                        return $data::getNumeroActividades($data->id_detallada,"07");
                    }
                ],
                [
                    'label' => 'Agosto', 'format' => 'html',
                    'value' => function($data){
                        return $data::getNumeroActividades($data->id_detallada,"08");
                    }
                ],
                [
                    'label' => 'Septiembre', 'format' => 'html',
                    'value' => function($data){
                        return $data::getNumeroActividades($data->id_detallada,"09");
                    }
                ],
                [
                    'label' => 'Octubre', 'format' => 'html',
                    'value' => function($data){
                        return $data::getNumeroActividades($data->id_detallada,"10");
                    }
                ],
                [
                    'label' => 'Noviembre', 'format' => 'html',
                    'value' => function($data){
                        return $data::getNumeroActividades($data->id_detallada,"11");
                    }
                ],
                [
                    'label' => 'Diciembre', 'format' => 'html',
                    'value' => function($data){
                        return $data::getNumeroActividades($data->id_detallada,"12");
                    }
                ],
            ],
        ]
    );
    echo '<div><h3>Servicios atendidos por Actividad (Horas)</h3></div>';
    echo GridView::widget([
            'dataProvider' => $dataProvider,
            'columns' => [
                /*['class' => 'yii\grid\SerialColumn'],*/
                ...
                [
                    'label' => 'Enero', 'format' => 'html',
                    'value' => function($data){
                        return $data::getHorasActividades($data->id_detallada,"01");
                    }
                ],
                [
                    'label' => 'Febrero', 'format' => 'html',
                    'value' => function($data){
                        return $data::getHorasActividades($data->id_detallada,"02");
                    }
                ],
                [
                    'label' => 'Marzo', 'format' => 'html',
                    'value' => function($data){
                        return $data::getHorasActividades($data->id_detallada,"03");
                    }
                ],
                [
                    'label' => 'Abril', 'format' => 'html',
                    'value' => function($data){
                        return $data::getHorasActividades($data->id_detallada,"04");
                    }
                ],
                [
                    'label' => 'Mayo', 'format' => 'html',
                    'value' => function($data){
                        return $data::getHorasActividades($data->id_detallada,"05");
                    }
                ],
                [
                    'label' => 'Junio', 'format' => 'html',
                    'value' => function($data){
                        return $data::getHorasActividades($data->id_detallada,"06");
                    }
                ],
                [
                    'label' => 'Julio', 'format' => 'html',
                    'value' => function($data){
                        return $data::getHorasActividades($data->id_detallada,"07");
                    }
                ],
                [
                    'label' => 'Agosto', 'format' => 'html',
                    'value' => function($data){
                        return $data::getHorasActividades($data->id_detallada,"08");
                    }
                ],
                [
                    'label' => 'Septiembre', 'format' => 'html',
                    'value' => function($data){
                        return $data::getHorasActividades($data->id_detallada,"09");
                    }
                ],
                [
                    'label' => 'Octubre', 'format' => 'html',
                    'value' => function($data){
                        return $data::getHorasActividades($data->id_detallada,"10");
                    }
                ],
                [
                    'label' => 'Noviembre', 'format' => 'html',
                    'value' => function($data){
                        return $data::getHorasActividades($data->id_detallada,"11");
                    }
                ],
                [
                    'label' => 'Diciembre', 'format' => 'html',
                    'value' => function($data){
                        return $data::getHorasActividades($data->id_detallada,"12");
                    }
                ],
            ],
        ]
    ...
    /*
    echo '<div><h3>Requerimientos por Proyecto</h3></div>';
    echo GridView::widget([
            'dataProvider' => $dataProvider,
            'columns' => [
                /*['class' => 'yii\grid\SerialColumn'],*/
                /*[
                    ...
                    'label'=>'Proyecto',
                    'filter'=>$searchModel->getProyecto(),
                    'value'=>'proyectoNombre',
                ],
                [
                    'label' => 'Enero', 'format' => 'html',
                    'value' => function($data){
                        return $data::getNumeroProyecto($data->id_detallada,"01");
                    }
                ],
                [
                    'label' => 'Febrero', 'format' => 'html',
                    'value' => function($data){
                        return $data::getNumeroProyecto($data->id_detallada,"02");
                    }
                ],
                [
                    'label' => 'Marzo', 'format' => 'html',
                    'value' => function($data){
                        return $data::getNumeroProyecto($data->id_detallada,"03");
                    }
                ],
                [
                    'label' => 'Abril', 'format' => 'html',
                    'value' => function($data){
                        return $data::getNumeroProyecto($data->id_detallada,"04");
                    }
                ],
                [
                    'label' => 'Mayo', 'format' => 'html',
                    'value' => function($data){
                        return $data::getNumeroProyecto($data->id_detallada,"05");
                    }
                ],
                [
                    'label' => 'Junio', 'format' => 'html',
                    'value' => function($data){
                        return $data::getNumeroProyecto($data->id_detallada,"06");
                    }
                ],
                [
                    'label' => 'Julio', 'format' => 'html',
                    'value' => function($data){
                        return $data::getNumeroProyecto($data->id_detallada,"07");
                    }
                ],
                [
                    'label' => 'Agosto', 'format' => 'html',
                    'value' => function($data){
                        return $data::getNumeroProyecto($data->id_detallada,"08");
                    }
                ],
                [
                    'label' => 'Septiembre', 'format' => 'html',
                    'value' => function($data){
                        return $data::getNumeroProyecto($data->id_detallada,"09");
                    }
                ],
                [
                    'label' => 'Octubre', 'format' => 'html',
                    'value' => function($data){
                        return $data::getNumeroProyecto($data->id_detallada,"10");
                    }
                ],
                [
                    'label' => 'Noviembre', 'format' => 'html',
                    'value' => function($data){
                        return $data::getNumeroProyecto($data->id_detallada,"11");
                    }
                ],
                [
                    'label' => 'Diciembre', 'format' => 'html',
                    'value' => function($data){
                        return $data::getNumeroProyecto($data->id_detallada,"12");
                    }
                ],
            ],
        ]
